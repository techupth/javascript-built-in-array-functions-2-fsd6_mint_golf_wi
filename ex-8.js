...
const totalPaidByLocation = bills
  ...
  .filter((bill, index, arr) => {
    // console.log(bill);
    // console.log(index);
    // console.log(arr);
    // console.log(arr.indexOf(bill));
    return arr.indexOf(bill) === index;
  })
  .map((location) => {
    // console.log(location);
    objTotalPaidByLocation[location] = 0;
    bills.map((data) => {
      // console.log(data);
      if (data.location === location) {
        return (objTotalPaidByLocation[location] += data.total);
      }
    });
    // console.log(obj);
    return objTotalPaidByLocation;
  });

// console.log(totalPaidByLocation);
console.log(objTotalPaidByLocation);
